 ...
 */
@ApiModel(description = "The Pagination Object contains information relating to the number of total results available as well as the number of results fetched and their relative positions. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Pagination {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(count, offset, totalCount, additionalProperties);
  }
