 ...
 */
@ApiModel(description = "The Meta Object contains basic information regarding the request, whether it was successful, and the response given by the API.  Check `responses` to see a description of types of response codes the API might give you under different cirumstances. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Meta {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(msg, responseId, status, additionalProperties);
  }
